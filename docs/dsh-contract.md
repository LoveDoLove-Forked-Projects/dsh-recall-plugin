...
>
> * 对应版本：**dsh 0.1.5-rc.1**（tag `dsh-v0.1.5-rc.1`，commit `183f08e`，2026-09-10 发布；**npm 已发布**（dist-tag `latest`），`npm install -g` 全局实装；前序 0.1.5-alpha.2 `b2e3b2a` 等基线均已并入；Session format 为 V3）
>
