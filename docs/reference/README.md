...
>
> 归档日期：2026-09-07，对应 [deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 仓库 `dsh-v0.1.3-alpha.1` tag `docs/` 目录（本地检出 `D:\workspace\DSH\deepseek-harness0.1.3-alpha.1`）。
>
> 归档 dsh 版本：0.1.3-alpha.1（`npm run check:dsh` 的漂移比对基准；重拉镜像后同步更新本字段，见下方「更新方式」）
>
