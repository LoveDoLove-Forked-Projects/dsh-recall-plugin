...
>
> 归档日期：2026-09-15，对应 [deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) 仓库 `dsh-v0.1.6-alpha.1` tag `docs/` 目录（raw.githubusercontent 按 tag 拉取，经系统代理）。
>
> 归档 dsh 版本：0.1.6-alpha.1（`npm run check:dsh` 的漂移比对基准；重拉镜像后同步更新本字段，见下方「更新方式」）
>
